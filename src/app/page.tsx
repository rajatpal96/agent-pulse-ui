      ...
      {!user ? (
        <div className="flex-1 flex flex-col items-center justify-center p-6 sm:p-10 max-w-6xl mx-auto w-full space-y-12 animate-fade-in my-auto">
          ...
          <div className="text-center space-y-5 max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-300 text-xs font-mono font-semibold shadow-[0_0_15px_rgba(16,185,129,0.15)]">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-3">
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 rounded-2xl bg-gradient-to-r from-emerald-500 via-teal-500 to-emerald-600 hover:brightness-110 text-slate-950 font-bold text-sm shadow-xl shadow-emerald-500/25 transition-all hover:scale-[1.02] active:scale-98"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 rounded-2xl bg-[#0c1410] hover:bg-emerald-950/40 border border-emerald-500/30 hover:border-emerald-500/50 text-white font-semibold text-sm shadow-lg transition-all"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 w-full">
            <div className="p-5 rounded-2xl glass-panel glass-panel-hover border border-emerald-500/20 space-y-3">
              <div className="p-3 rounded-xl bg-emerald-500/15 border border-emerald-500/30 text-emerald-400 w-fit">
            ...
            <div className="p-5 rounded-2xl glass-panel glass-panel-hover border border-indigo-500/20 space-y-3">
            ...
            <div className="p-5 rounded-2xl glass-panel glass-panel-hover border border-teal-500/20 space-y-3">
              <div className="p-3 rounded-xl bg-teal-500/15 border border-teal-500/30 text-teal-400 w-fit">
            ...
            <div className="p-5 rounded-2xl glass-panel glass-panel-hover border border-cyan-500/20 space-y-3">
              <div className="p-3 rounded-xl bg-cyan-500/15 border border-cyan-500/30 text-cyan-400 w-fit">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 text-xs text-slate-400">
            <span className="text-slate-400 mr-1 font-medium">Supported Fleet:</span>
            {[
